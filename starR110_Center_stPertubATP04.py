...
for n in range(num_step):
    ...
    if n < 2000:
        ...
        #Create VTK files for visualization output
            vtkfile_glc = File('results_starR110_Center_stPertubATP04/glc/glc_R110_Center_stATP04_%sof8000s.pvd' % n)
            vtkfile_atp = File('results_starR110_Center_stPertubATP04/atp/atp_R110_Center_stATP04_%sof8000s.pvd' % n)
            vtkfile_adp = File('results_starR110_Center_stPertubATP04/adp/adp_R110_Center_stATP04_%sof8000s.pvd' % n)
            vtkfile_gly = File('results_starR110_Center_stPertubATP04/gly/gly_R110_Center_stATP04_%sof8000s.pvd' % n)
            vtkfile_pyr = File('results_starR110_Center_stPertubATP04/pyr/pyr_R110_Center_stATP04_%sof8000s.pvd' % n)
            vtkfile_lac = File('results_starR110_Center_stPertubATP04/lac/lac_R110_Center_stATP04_%sof8000s.pvd' % n)
...
np.save('./output_starR110_Center_stPertubATP04', np.asarray(list_of_list))
